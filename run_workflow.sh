snakemake --config input_dicoms_path="../test_dicoms" -np data/derivatives/3T/qT1qMT/sub-rfl260123normanoel/ses-1/sub-rfl260123normanoel_ses-1_acq-vibeMT_T1map_registeredtoMP2RAGE.nii.gz --dag | sed -n "/digraph/,/}/p" | dot -Tsvg > qT1_dag.svg
