...
if command -v nvidia-smi; then
    snakemake --config input_dicoms_path="/home/rflaherty/test_dicoms" --sdm conda apptainer --cores 8 --singularity-args "--nv -e" --rerun-incomplete
else
    snakemake --config input_dicoms_path="../test_dicoms" --sdm conda apptainer --cores 8 --rerun-incomplete
fi
