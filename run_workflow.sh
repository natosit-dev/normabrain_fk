...
if command -v nvidia-smi; then
    snakemake --config input_dicoms_path="/home/rflaherty/test_dicoms" --resources mem_mb=10000 --sdm conda apptainer --cores 8 --singularity-args "--nv -e"
else
    snakemake --config input_dicoms_path="../test_dicoms" --resources mem_mb=9300 --sdm conda apptainer --cores 8
fi
