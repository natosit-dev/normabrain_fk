...
if command -v nvidia-smi; then
    snakemake --config input_dicoms_path="/DATA_CEMEREM/data/users/ttroalen/vida/normadev/" --resources mem_mb=10000 --sdm conda apptainer --cores 8 --singularity-args "--nv -e" --rerun-incomplete
else
