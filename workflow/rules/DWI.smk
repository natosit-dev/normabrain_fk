...
rule nyu_designer:
    ...
    shell:
        ...
        designer "{input.dwi}" "{output.mif}" -denoise -shrinkage frob -adaptive_patch -degibbs -eddy -rpe_pair $HOME/{input.b0} -normalize -mask -scratch {params.preproc} -nocleanup -n_cores {threads}
        """
