...
#     container:
#         "docker://freesurfer/synthstrip:1.8-gpu" #use the synthstrip container instead of the freesurfer container to avoid error
#     threads:
#         4
#     shell:
#         """
...
#     input:
#         fmap = "data/derivatives/{field_strength}/B1map/{subject}/{session}/{subject}_{session}_acq-famp_registeredto{seq}t1w_smooth.nii.gz",
