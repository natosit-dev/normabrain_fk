...
python3 workflow/scripts/copy_dicoms_by_field_strength.py ../test_dicoms .
...
fixmeta 3T/rawdata/bids/ perf/* '{"BackgroundSuppression": false}'
fixmeta 3T/rawdata/bids/ perf/* '{"VascularCrushing": false}'